...
# 동작화면
| <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.32.png" width=340, height=700>  | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.38.png" width=340, height=700> | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.40.png" width=340, height=700> |
| :-------------: | :-------------: | :-------------: |
|  **메인 화면** | **메모 화면**  | **사진 화면** |
| <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.42.png" width=340, height=700>  | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.45.png" width=340, height=700> | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.51.56.png" width=340, height=700> |
|  **설정 화면** | **열림 추적**  | **적용 기술** |
| <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.52.10.png" width=340, height=700>  | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.52.14.png" width=340, height=700> | <img src="https://boanprojects.s3.ap-northeast-2.amazonaws.com/%EB%A7%88%EC%8B%9C%EB%A9%9C%EB%A1%9C/Simulator+Screen+Shot+-+iPhone+14+Pro+Max+-+2023-09-19+at+19.52.20.png" width=340, height=700> |
...
│   │       └── Contents.json
│   ├── Info.plist
│   ├── MarshmallowWidget.intentdefinition
│   ├── MarshmallowWidget.swift
│   ├── MarshmallowWidgetBundle.swift
│   └── MarshmallowWidgetLiveActivity.swift
├── Podfile
├── Podfile.lock
├── README.md
...
│   ├── Resource
│   │   ├── CoreData
│   │   │   ├── ImageTask.xcdatamodeld
│   │   │   │   └── ImageTask.xcdatamodel
│   │   │   │       └── contents
│   │   │   ├── SecureMarshmallow.xcdatamodeld
│   │   │   │   └── SecureMarshmallow.xcdatamodel
│   │   │   │       └── contents
│   │   │   └── TasksList.xcdatamodeld
│   │   │       └── Tasks.xcdatamodel
│   │   │           └── contents
│   │   ├── Storyboard
│   │   │   └── Base.lproj
...
│       │   ├── Extensions+NSNotificationName.swift
...
│           ├── CoreMemo(Old)
│           │   ├── Detail
│           │   │   ├── DetailMemoPresenter.swift
│           │   │   └── DetailMemoViewController.swift
│           │   ├── MemoCollectionViewCell.swift
│           │   ├── MemoModel
│           │   │   ├── LockModel.swift
│           │   │   ├── LockViewModel.xcdatamodeld
│           │   │   │   └── LockViewModel.xcdatamodel
│           │   │   │       └── contents
│           │   │   ├── MemoData.swift
│           │   │   ├── Passwords.swift
│           │   │   └── TaskModel.swift
...
│           │       ├── DemoLockView.swift
│           │       ├── MemoListPresenterOld.swift
│           │       ├── MemoListViewControllerOld.swift
│           │       ├── PasswordWrite
│           │       │   ├── MemoWritePresenter.swift
...
│           ├── Explanation
│           │   ├── DetailExplanationViewController.swift
│           │   └── ExplanationViewController.swift
│           ├── File
│           │   ├── FilePresenter.swift
│           │   └── FileViewController.swift
│           ├── Home
│           │   ├── AddMainCollectionViewController.swift
│           │   ├── AlarmCollectionViewCell.swift
│           │   ├── CacheClearCollectionViewCell.swift
│           │   ├── HMACViewController.swift
│           │   ├── HomeViewController.swift
│           │   ├── LargeBluetoothCollectionViewCell.swift
│           │   ├── LargeInformationCollectionViewCell.swift
│           │   ├── MiddleAlamCollectionViewCell.swift
│           │   ├── MiddleCalculatorColloectionViewCell.swift
│           │   ├── SamilInformationCollectionViewCell.swift
│           │   ├── ShhCollectionViewCell.swift
...
│           │   ├── ImageFileCollectionViewCell.swift
...
│           │   │       ├── BagFridaViewController.swift
│           │   │       └── BagiOSWebViewController.swift
│           │   ├── Capture
│           │   │   ├── CaptureTrackingPresenter.swift
│           │   │   └── CaptureTrackingViewController.swift
│           │   ├── DeveloperIntroduction
│           │   │   ├── DevelopersPresenter.swift
│           │   │   ├── DevelopersTableViewCell.swift
│           │   │   └── DevelopersViewController.swift
│           │   ├── FriendViewController.strings
│           │   ├── Gmail
│           │   │   ├── GmailCell.swift
